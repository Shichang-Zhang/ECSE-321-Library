<template>
  <div>
    <b-form inline>
      ...
      <b-button v-on:click="findItems(itemName,form.ItemCategory)" variant="primary" style="margin-left: 30px;" type="reset">Search</b-button>
    ...
    <b-modal id="date-modal" title="Choose Date" @ok="handleReserveConfirm(currentUserId,selectedItems,itemReservationStartDate,itemReservationEndDate)">
      <div>
        <b-form >
          <b-form-group
            label="Start Date"
          ...
          >
            <b-form-datepicker id="datepicker1" v-model="itemReservationStartDate" class="mb-2" locale="en"></b-form-datepicker>
          </b-form-group>
          ...
          >
            <b-form-datepicker id="datepicker2" v-model="itemReservationEndDate" class="mb-2" locale="en"></b-form-datepicker>
          </b-form-group>
        </b-form>
      </div>
    </b-modal>
