  ...
  <div>
    ...
    <table>
      ...
      <tr v-for="item in itemList" >
        ...
        <td><button @click="deleteItem(item.id)" type="reset">Delete</button>
        <td><button @click="checkout(currentUserId,item.id,checkoutStartDate,checkoutTime)" type="reset">CheckOut</button>
        </td>
      ...
      <tr>
        ...
        <td>
          <button v-bind:disabled="!itemName||!itemItemCategory" @click="createNewItem(itemName,itemItemCategory)" type="reset">Create</button>
        </td>
        <td>
          <button v-bind:disabled="!itemItemCategory" @click="findItems(itemName,itemItemCategory)" type="reset">Search</button>
        </td>
      </tr>
    </table>
